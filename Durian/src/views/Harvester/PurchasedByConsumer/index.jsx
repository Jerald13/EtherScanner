...
export default function Marketplace() {
    ...
    const handleSubmit = async (event) => {
        ...
        const durian = await contract.methods.fetchDurianBufferTwo(harvesterAddress).call()

        try {
            await contract.methods
                .purchaseDurianByConsumer(harvesterAddress)

                .send({
                    from: addresses[0],
                    value: durian.harvestedDurianPrice,
                })
